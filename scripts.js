    ...
    */
    const cargarTabla = (misProductos) => {
        ...
        misProductos.forEach(product => {
            ...
            masButton.className = "btn btn-primary btn-sm ms-1";    
            ...
            menosButton.className = "btn btn-secondary btn-sm me-1";
    ...
    fetch("https://mocki.io/v1/6a8a3b70-42de-425a-8eb9-d9cfd275e362")
